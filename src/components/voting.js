          ...
          <div className="votingBack">
            ...
            <div className="votingBoxes">
              ...
              <div className="votingBox2">
                <div className="votingCheckbox1"></div>
                <div className="votingCheckmark1">&#x2713;</div>
                <div className="votingLabel1"> Appointing the Auditor </div>
                <div className="votingText1"> PricewaterhouseCoopers LLP (PwC) has been our external auditor since 1983. The Board, on the recommendation of the Audit Committee, recommends that PwC be reappointed as auditor and that the Board be authorized to set the auditor’s remuneration. The audit firm appointed at the Meeting will serve until the end of the Company’s next annual shareholders’ meeting.</div>
                <div className="votingRead1">Read More</div>
              </div>
